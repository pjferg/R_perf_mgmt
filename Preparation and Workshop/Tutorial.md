...
* The second row down gives us the names of the first eight variables in our data set. The notes at the bottom of the table tell us that there are '6 more variables' not reported in the output.
